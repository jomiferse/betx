...
public record DiagnosticsRecommendationReadiness(
    ...
    long realBetsTotal,
    long post25RealBets,
    long post25RealBetsWithRecommendationId,
    long post25RealBetsWithoutRecommendationId,
    long realBetsWithRecommendationIdButMissingBetRecommendation,
    long realBetsLinkedToCanonicalRecommendation,
    long realBetsLinkedToActiveRecommendations,
    long realBetsLinkedToCoveredRecommendations,
    long realBetsLinkedToExpiredRecommendations,
    ...
    public DiagnosticsRecommendationReadiness withReadiness(
        ...
        return new DiagnosticsRecommendationReadiness(
            ...
            post25RealBetsWithoutRecommendationId,
